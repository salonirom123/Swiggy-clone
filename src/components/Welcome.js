...
import swiggy from "../images/swiggy (1).png"
  ...
  return (
    ...
    <div className='flex'>
      <div className='h-screen w-9/12 p-10'>
        ...
        {auth?.currentUser?.phoneNumber ? <Link to="/main"><img src={swiggy} className='w-48 h-14'alt=''/></Link>
        : <img src={swiggy} className='w-48 h-14'alt=''/>}
      ...
      <img src={food} className='h-screen w-5/12'alt=''/>
