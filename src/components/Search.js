        ...
        {location?.state?.data?.filter((data) => data.name.includes(searchItems)).map((item)=>{
          return <>
           <div className='flex items-center mt-6'>
            <img src={item?.photo?.images?.original?.url} className='w-16 h-16 rounded-sm' alt=""/>
            <div className='ml-3'>
